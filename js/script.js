...
const translations = {
  es: {
    ...
    why0Text: "Analizamos tu negocio, tu funnel actual y tus m&eacute;tricas reales. Identificamos d&oacute;nde est&aacute; el cuello de botella antes de proponer cualquier soluci&oacute;n.",
    why0Time: "Semana 1",
    why1Step: "Paso 01",
    why1Title: "Estrategia y Visi&oacute;n",
    why1Text: "Definimos objetivos claros, KPIs medibles y una hoja de ruta alineada con tu modelo de negocio. Nada se ejecuta sin una direcci&oacute;n validada.",
    why1Time: "Semanas 2-3",
    why2Step: "Paso 02",
    why2Title: "Ejecuci&oacute;n y Tecnolog&iacute;a",
    why2Text: "Implementamos soluciones de marketing, automatizaci&oacute;n, UX e inteligencia artificial definidas en la estrategia. Ejecutamos con foco en rendimiento y escalabilidad.",
    why2Time: "Mes 1-3",
    why3Step: "Paso 03",
  ...
  en: {
    ...
    why0Step: "Step 00",
    why0Title: "Diagnosis",
    why0Text: "We analyze your business, current funnel and real metrics. We identify the bottleneck before proposing any solution.",
    why0Time: "Week 1",
    why1Step: "Step 01",
    why1Title: "Strategy &amp; Vision",
    why1Text: "We define clear goals, measurable KPIs and a roadmap aligned with your business model. Nothing is executed without validated direction.",
    why1Time: "Weeks 2-3",
    why2Step: "Step 02",
    why2Title: "Execution &amp; Technology",
    why2Text: "We implement marketing, automation, UX and AI solutions defined in the strategy. Execution focuses on performance and scalability.",
    why2Time: "Months 1-3",
    why3Step: "Step 03",
...
function setLanguage(language) {
  ...
  if (language === 'es') {
    try {
      ...
      const navMapRestore = [
        ...
        ['#nav-academy','nav-academy'],
        ['#nav-academy-mobile','nav-academy-mobile'],
  ...
  const elementsToUpdate = {
    ...
    'nav-academy': 'navAcademy',
    'nav-academy-mobile': 'navAcademy',
