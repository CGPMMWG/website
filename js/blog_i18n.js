(function(){
  const blogCopy = {
    es: {
      ...
      articleTitle: "Errores de marketing que frenan a cualquier negocio (y cómo evitarlos)",
    ...
    en: {
      ...
      articleTitle: "Marketing Mistakes That Block Business Growth (and How to Avoid Them)",
